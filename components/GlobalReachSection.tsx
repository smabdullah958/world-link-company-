...
export default function GlobalReachSection() {
  ...
  return (
    <section className="py-12 bg-[#d8e6f6]" data-aos="fade-left">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-2 bg-[#D4AF37]/10 text-[#D4AF37] rounded-full text-sm font-medium mb-4">
            Global Reach
          </span>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#002D62] mb-6 text-center" data-aos="fade-up">
            Worldwide Trade Network
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto text-left" data-aos="fade-down">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 " data-aos="fade-up">
          ...
          {/* Countries Served */}
          <div className="text-center p-6 bg-[#F8F9FA] rounded-xl hover:scale-105 transition-transform duration-1000 hover:border-white border-2 hover:shadow-md 
          hover:shadow-black">
          ...
          {/* Port Locations */}
          <div className="text-center p-6 bg-[#F8F9FA] rounded-xl hover:scale-105 
          hover:border-white border-2 hover:shadow-md 
          hover:shadow-black  transition-transform duration-1000">
            <div className="w-16 h-16 bg-[#002D62] rounded-xl flex items-center justify-center mx-auto mb-4">
          ...
          {/* Warehouses */}
          <div className="text-center p-6 bg-[#F8F9FA] rounded-xl hover:scale-105 
          transition-transform duration-1000 hover:border-white border-2 hover:shadow-md 
          hover:shadow-black ">
            <div className="w-16 h-16 bg-[#002D62] rounded-xl flex items-center justify-center mx-auto mb-4">
              <i className="ri-home-8-line text-2xl text-white"></i>
            </div>
          ...
          transition-transform duration-1000 hover:border-white border-2 hover:shadow-md 
          hover:shadow-black ">
            <div className="w-16 h-16 bg-[#002D62] rounded-xl flex items-center 
